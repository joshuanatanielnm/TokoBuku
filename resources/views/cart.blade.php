            ...
            <div class="w-4/6">
                ...
                @foreach ($carts as $cart)
                    <div class="flex bg-gray-200 p-3 rounded mt-4">
                        <div class="mt-4">
                            <img src="{{asset('upload/fotobuku/'.$cart->foto_buku)}}" alt="" class="w-40">
                        </div>
                        <div class="self-center ml-5">
                            <span  class="text-2xl font-medium">{{$cart->judul_buku}}</span>
                            <br>
                            {{$cart->pengarang_buku}}
                        <div>
                            <br>
                            <span class="font-medium text-red-400 mb-10">Stok: {{$cart->stok_buku}}</span>
                        </div>
                        <br><br>
                        <a href="/delete/{{$cart->id_cart}}/{{Session::get('id_anggota')}}" class="rounded-full px-4 py-2 mt-5  items-center bg-red-500 text-white font-medium hover:bg-red-600">
                            Hapus
                        </a>
                        </div>
                    </div>
